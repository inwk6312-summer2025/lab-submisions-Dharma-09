...
def set_interfaces(append_url, interface_name):
    ...
    data = {
        "ietf-interfaces:interface": {
            "name": interface_name,  # This should dynamically use the interface_name passed to the function
            "description": "Changed through Restconf",
            "type": "iana-if-type:ethernetCsmacd",
            "enabled": True,  # 'true' should be a boolean
            "ietf-ip:ipv4": {
                "address": [
                    {
                        "ip": "10.0.10.3",
...
# Make sure to call the function with the correct interface name
